...
// @resource     NOVEL_CSS https://raw.githubusercontent.com/naimiliu/novelreader/refs/heads/main/mobil/novel-style.css?v1.2.10
// @grant        GM_addStyle
...
const NovelUI = {
    ...
    renderReader(article) {
        ...
        settingContainer.style.right = `${scrollBarWidth}px`;
        this.shadow.appendChild(settingContainer);

        // --- 配色選項面板
        const colorOptions = document.createElement('div');
        colorOptions.className = 'color-options';
        colorOptions.style.right = `${scrollBarWidth}px`;
        ...
        navContainer.style.right = `${scrollBarWidth}px`;
